  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="flex flex-wrap text-5xl md:text-7xl lg:text-8xl xl:text-[7rem] tracking-tighter font-extrabold">
          <span className="text-transparent animate-gradient bg-clip-text bg-gradient-to-r from-[var(--develop-start-gradient)] to-[var(--develop-end-gradient)]">
            DocX.
          </span>
          <span>Chat.</span>
          <span>AI.</span>
